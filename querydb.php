...
echo "";
		...
		$sql = "insert into query(wquery) values('$message')";
        $result = mysqli_query($conn,$sql);
		echo"<center>"; 
        echo "<div class='card text-white bg-success mb-3' style='max-width: 18rem;'><div class='card-header'>Query Posted!</div><div class='card-body'><h5 class='card-title'>Thank You</h5><p class='card-text'>We appreciate you for taking out your valueable time for us </p><button class='btn-secondary'><a href='http://localhost/edutor-main/'>Continue</button></div></div>";
        echo "</center>"; 
