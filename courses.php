    ...
    <div class="modal-dialog modal-sm" id="cform">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title text-center form-title" style="color:white;">Payment Gateway</h4>            <button type="button" class="close" data-dismiss="modal" ><a href='http://localhost/edutor-main/courses.php' style='font-size: 30px;color:black;float:right;'>&times;</a></button>
        </div>
...
<!--                  password-->
 ...
 btn-block btn-flat"  >Buy this course!</button>
                  </div>
                </div>
              </form>
            </div>
