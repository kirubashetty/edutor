  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="home.php"><span><b> EDUTOR</b></span></a>
      </div>
    ...
    <div class="modal-dialog modal-sm">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title text-center form-title" style="color:white;"><b>LOGIN</b></h4>
        </div>
        <div class="modal-body padtrbl">

          <div class="login-box-body">
            <p class="login-box-msg"><b>LOGIN TO JOIN EDUTOR</b></p>
                ...
                <div class="row">
                  <div class="col-xs-12">
                    <div class="checkbox icheck">
                      <label>
                                <input type="checkbox" id="loginrem" ><b>REMEMBER ME</b>
                              </label>
                    </div>
                  </div>
                  <div class="col-xs-12">
                    <button type="submit" class="btn btn-lightpink
 btn-block btn-flat"  >Log In</button>
                  </div>
                </div>
              </form>
            </div>
...
<div class="modal fade" id="signin" role="dialog">
          ...
          <div class="login-box-body">
            ...
            <div class="form-group">
              <form name="" id="loginForm" method="post" action="signupltc.php">
                ...
                <div class="form-group has-feedback">
                  <!----- mail -------------->
                  <input class="form-control" placeholder="Father's name"  type="text" autocomplete="off" name="faname" />
                  <span style="display:none;font-weight:bold; position:absolute;color: red;position: absolute;padding:4px;font-size: 11px;background-color:rgba(128, 128, 128, 0.26);z-index: 17;  right: 27px; top: 5px;" id="span_loginid"></span>
                  <!---Alredy exists  ! -->
                  <span class="glyphicon glyphicon-user form-control-feedback" style="background-color: rgb(230,230,230);"></span>
                </div>
                <div class="form-group has-feedback">
                  <!----- mail -------------->
                  <input class="form-control" placeholder="Gender"  type="text" autocomplete="off" name="gender" />
                  <span style="display:none;font-weight:bold; position:absolute;color: red;position: absolute;padding:4px;font-size: 11px;background-color:rgba(128, 128, 128, 0.26);z-index: 17;  right: 27px; top: 5px;" id="span_loginid"></span>
                  <!---Alredy exists  ! -->
                  <span class="glyphicon glyphicon-user form-control-feedback" style="background-color: rgb(230,230,230);"></span>
                </div>
    ...
    <label class="radio-inline">
      <input type="radio" name="regas"  cheked value="Student" >Student
    </label>
    <label class="radio-inline">
      <input type="radio" name="regas" value="Tutor">Tutor
    </label>
...
<!--    end of signup form-->
    ...
    <div class="content">
    <b> Edutor is an web based Application used by the students to enroll the courses and gain knownledge.In this Application students are provided with more feasility like wide range of courses,chats with instructor,Responsive plication even in mobile view.. etc.  </div>
   <hr>
...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
  ...
  <footer id="footer" class="footer">
    <div class="container text-center">
      ...
      ©2020 EDUTOR  All rights reserved
      <div class="credits">
        <!--
