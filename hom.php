      ...
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="service-box text-center">
            <div class="icon-box">
              <i class="fa fa-html5 color-lightpink
"></i>
            </div>
            <div class="icon-text">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="service-box text-center">
            <div class="icon-box">
              <i class="fa fa-css3 color-lightpink
"></i>
            </div>
            <div class="icon-text">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="service-box text-center">
            <div class="icon-box">
              <i class="fa fa-joomla color-lightpink
"></i>
            </div>
            <div class="icon-text">
        ...
        <div class="col-md-4 col-sm-4">
          <div class="price-table">
            ...
            <div class="price-in mart-15">
              <a href="#" class="btn btn-bg lightpink
 btn-block">PURCHACE</a>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-4">
