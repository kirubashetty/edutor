...
<style>
  ...
  background-image: url(https://images.unsplash.com/photo-1585844618972-71094d96c356?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=400&fit=max&ixid=eyJhcHBfaWQiOjE0NTg5fQ);
...
<form action="addvideos.php" method="get">
        <button type="submit"  class="links"><span class="glyphicon glyphicon-book"></span>Add new course</button>
</form>

<!--<form action="videos.php" method="get">
        <button type="submit"  class="links"><span class="glyphicon glyphicon-book"></span>Videos</button>
</form>-->
